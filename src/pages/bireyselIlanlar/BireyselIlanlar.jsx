...
return (
  ...
  <Grid item xs={10} lg={3}> 
    <Grid container direction="column" marginTop={6} marginLeft={3} alignItems="center" spacing={2}>
        ...
        <Grid item>
        <Grid container direction="column" marginTop={2} marginLeft={3} alignItems="center" spacing={2}>
          <Stack spacing={3} sx={{ width: 250 }}>
          <Typography variant="body2" style={{ fontSize: "10px" }}>
            <Autocomplete
              multiple
        ...
        <Grid item>
        <Grid container direction="column" marginTop={2} marginLeft={3} alignItems="center" spacing={1}>
          <Box
            sx={{
              p: 1.5,
              border: 1,
      ...
      <Grid container justifyContent="center" alignItems="center" marginTop={3} spacing={2}>
